...
(function () {
    ...
    var basicBot = {
        ...
        cmdLink: "!commands (or !help) / !voteratio @user / !eta / !ping / !link / !jointime @user / !cookie @user / !motd (X) / !gif / !ask or !8ball (your question).",
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['deu-lhe um biscoito de chocolate!',
                    ...
                    'você recebe um e seco, biscoito velho liso. Ele foi o último na bolsa. Gross.',
                    'lhe dá um bolinho de açúcar. O que, sem geada e polvilha? 0/10 não iria tocar.',
                    ...
                    'assa-lhe biscoitos frescos, cheiro surpreendente.'
                ],
                getCookie: function () {
